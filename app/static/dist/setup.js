import { ApiError, beginAction, byId, downloadBlob, errorMessage, formatValue, getJson, loadingToast, postJson, runPeriodic, singleFlight, toast, } from "./common.js";
...
function renderVerify(status) {
    ...
    if (status.running) {
        ...
        if (verifyTimer === undefined)
            verifyTimer = window.setInterval(() => void pollVerify(), 1000);
        return;
    }
