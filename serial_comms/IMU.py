...
class IMU:
    ...
    def initIMU(self):
        if(self._BerryIMUversion == 1):   #For BerryIMUv1
        ...
        elif(self._BerryIMUversion == 2):       #For BerryIMUv2
            #initialise the accelerometer
        ...
        elif(self._BerryIMUversion == 3):       #For BerryIMUv3
            #initialise the accelerometer
